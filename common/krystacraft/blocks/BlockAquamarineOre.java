...
public class BlockAquamarineOre extends Block {
	...
	public BlockAquamarineOre(int id) {
		super(id, Material.rock);
		
		this.setUnlocalizedName(Strings.BlockAquamarineOre_unlocalizedName);
	...
	public void registerIcons(IconRegister icon) {
		blockIcon = icon.registerIcon(References.MOD_ID.toLowerCase() + ":block" + Strings.BlockAquamarineOre_unlocalizedName);
	}
