...
public class BlockKrystaOre extends Block {
	...
	public BlockKrystaOre(int id) {
		...
		this.setUnlocalizedName(Strings.BlockKrystaOre_unlocalizedName);
	...
	public void registerIcons(IconRegister icon) {
		blockIcon = icon.registerIcon(References.MOD_ID.toLowerCase() + ":block" + Strings.BlockKrystaOre_unlocalizedName);
	}
