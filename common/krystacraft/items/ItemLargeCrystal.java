...
public class ItemLargeCrystal extends Item {
	...
	public ItemLargeCrystal(int id) {
		...
		this.setUnlocalizedName(Strings.ItemLargeCrystal_unlocalizedName);
	...
	public void registerIcons(IconRegister icon) {
		itemIcon = icon.registerIcon(References.MOD_ID.toLowerCase() + ":item" + Strings.ItemLargeCrystal_unlocalizedName);
	}
