...
public class ItemRhodoliteCrystalLarge extends Item {

	public ItemRhodoliteCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemRhodoliteCrystalLarge_unlocalizedName);
