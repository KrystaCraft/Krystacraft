...
public class ItemAquamarineCrystal extends Item {

	public ItemAquamarineCrystal(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemAquamarineCrystal_unlocalizedName);
