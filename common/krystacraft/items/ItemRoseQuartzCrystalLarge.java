...
public class ItemRoseQuartzCrystalLarge extends Item {

	public ItemRoseQuartzCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemRoseQuartzCrystalLarge_unlocalizedName);
