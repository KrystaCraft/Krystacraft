...
public class ItemChalcedonyCrystalLarge extends Item {

	public ItemChalcedonyCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemChalcedonyCrystalLarge_unlocalizedName);
