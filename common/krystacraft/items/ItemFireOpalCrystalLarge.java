...
public class ItemFireOpalCrystalLarge extends Item {

	public ItemFireOpalCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemFireOpalCrystalLarge_unlocalizedName);
