...
public class ItemSodaliteCrystalLarge extends Item {

	public ItemSodaliteCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemSodaliteCrystalLarge_unlocalizedName);
