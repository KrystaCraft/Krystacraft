...
public class ItemTanzaniteCrystalLarge extends Item {

	public ItemTanzaniteCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemTanzaniteCrystalLarge_unlocalizedName);
