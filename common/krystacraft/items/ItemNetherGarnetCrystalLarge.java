...
public class ItemNetherGarnetCrystalLarge extends Item {

	public ItemNetherGarnetCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemNetherGarnetCrystalLarge_unlocalizedName);
