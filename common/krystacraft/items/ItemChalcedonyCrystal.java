...
public class ItemChalcedonyCrystal extends Item {

	public ItemChalcedonyCrystal(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemChalcedonyCrystal_unlocalizedName);
