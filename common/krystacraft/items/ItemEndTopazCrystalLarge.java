...
public class ItemEndTopazCrystalLarge extends Item {

	public ItemEndTopazCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemEndTopazCrystalLarge_unlocalizedName);
