...
public class ItemSugiliteCrystalLarge extends Item {

	public ItemSugiliteCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemSugiliteCrystalLarge_unlocalizedName);
