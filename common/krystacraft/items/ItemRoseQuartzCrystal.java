...
public class ItemRoseQuartzCrystal extends Item {

	public ItemRoseQuartzCrystal(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemRoseQuartzCrystal_unlocalizedName);
