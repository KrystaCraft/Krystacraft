...
public class ItemHackmaniteCrystalLarge extends Item {

	public ItemHackmaniteCrystalLarge(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemHackmaniteCrystalLarge_unlocalizedName);
