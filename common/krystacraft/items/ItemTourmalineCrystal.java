...
public class ItemTourmalineCrystal extends Item {

	public ItemTourmalineCrystal(int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemTourmalineCrystal_unlocalizedName);
