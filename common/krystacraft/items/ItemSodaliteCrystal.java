...
public class ItemSodaliteCrystal extends Item {
	...
	public ItemSodaliteCrystal(int id) {
		...
		this.setUnlocalizedName(Strings.ItemSodaliteCrystal_unlocalizedName);
	...
	public void registerIcons(IconRegister icon) {
		itemIcon = icon.registerIcon(References.MOD_ID.toLowerCase() + ":item" + Strings.ItemSodaliteCrystal_unlocalizedName);
	}
}