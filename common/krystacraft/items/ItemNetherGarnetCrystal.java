...
public class ItemNetherGarnetCrystal extends Item {

	public ItemNetherGarnetCrystal (int id) {
		super(id);
		
		this.setCreativeTab(KrystaCraft.krystacraftTab);
		this.setUnlocalizedName(Strings.ItemNetherGarnetCrystal_unlocalizedName);
